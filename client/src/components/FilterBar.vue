    ...
    <div class="filters-container">
      <div class="filters-grid">
        <div class="filter-group">
          ...
          <select v-model="selectedPeriod" class="filter-select" :aria-label="t('filters.timePeriod')">
        ...
        <div class="filter-group">
          ...
          <select v-model="selectedLocation" class="filter-select" :aria-label="t('filters.location')">
        ...
        <div class="filter-group">
          ...
          <select v-model="selectedCategory" class="filter-select" :aria-label="t('filters.category')">
            <option value="all">{{ t('filters.all') }}</option>
        ...
        <div class="filter-group">
          ...
          <select v-model="selectedStatus" class="filter-select" :aria-label="t('filters.orderStatus')">
            <option value="all">{{ t('filters.all') }}</option>
