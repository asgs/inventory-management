<template>
  <div class="reports">
    ...
    <div v-if="loading" class="loading" aria-live="polite" role="status">Loading reports...</div>
    ...
    <div v-else>
      ...
      <div class="card">
        ...
        <div class="table-container">
          <table class="reports-table" aria-label="Quarterly performance data">
            <thead>
              <tr>
                <th>Quarter</th>
                <th>Total Orders</th>
      ...
      <div class="card">
        ...
        <div class="table-container">
          <table class="reports-table" aria-label="Month-over-month analysis">
            <thead>
              <tr>
                <th>Month</th>
                <th>Orders</th>
